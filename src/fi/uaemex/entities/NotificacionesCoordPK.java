...
public class NotificacionesCoordPK implements Serializable {
    ...
    public NotificacionesCoordPK(int idGrupo, Date fechaHoraNotificacion) {
    ...
    public String toString() {
        return "entities.NotificacionesCoordPK[ idGrupo=" + idGrupo + ", fechaHoraNotificacion=" + fechaHoraNotificacion + " ]";
    }
