...
public class GrupoRespaldoPK implements Serializable {
    ...
    public GrupoRespaldoPK(String claveMateria, String periodo, String nombre) {
    ...
    public String toString() {
        return "entities.GrupoRespaldoPK[ claveMateria=" + claveMateria + ", periodo=" + periodo + ", nombre=" + nombre + " ]";
    }
